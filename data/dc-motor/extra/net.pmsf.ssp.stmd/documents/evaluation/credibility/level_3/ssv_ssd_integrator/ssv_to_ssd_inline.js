...
exports.integrateSsvIntoSsd = integrateSsvIntoSsd;
...
function integrateSsvIntoSsd(ssdFileIn, ssdFileOut) {
    if (!ssdFileIn && !ssdFileOut) {
    ...
    if (ssdFileOut === undefined)
        throw("ssd output file must be given, use -o or --output")
